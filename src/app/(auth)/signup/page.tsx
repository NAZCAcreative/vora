        ...
        <div className="w-full max-w-md flex flex-col gap-stack-lg">
          ...
          <div className="bg-surface-container-lowest rounded-xl p-5 sm:p-8 shadow-[0px_4px_20px_rgba(0,0,0,0.04)] border border-surface-variant/30 w-full fade-in">
            ...
            >
              ...
              <button
                type="button"
                onClick={() => showToast('Google 로그인은 준비 중입니다')}
                className="flex items-center justify-center gap-2 w-full py-4 px-4 bg-white border border-outline-variant rounded-lg text-label-lg font-label-lg text-on-surface hover:bg-surface-container-low transition-all active:scale-[0.98]"
              >
